...
describe('Keyword Tests on worksheets', function() {
    ...
    function test_keywords(index) {
        ...
        describe('keyword tests using TPCH worksheet 3' + ' -- ' + kwCount, function() {
    ...
    for (var i = 90; i < kwTests.length; i++) {
...
describe('cleanup for keyword test', function() {
    it('deleting tpch worksheet', function() {
        deleteWorksheet(TPCH_WORKSHEET_NAME);
    });
});
