 ...
 * optionally, set disable_ws to true will run the query only for table based queries
 */
    ...
    tests: [{
        ...
        results: {
            ...
            table: {
                ...
                sel: ['MONTHLY', 'MONTHLY'],
                val: ['Feb 1992', 'Jan 1992']
            }
        }
    }, {
        count: 8,
        query: 'commit date by quantity',
        disable_ws: true,
        results: {
            headline: {
        ...
        count: 31,
        query: 'discount by commit date by supplier region',
        results: {
            headline: {
