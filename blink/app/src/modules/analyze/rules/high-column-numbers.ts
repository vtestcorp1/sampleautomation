 ...
 *
 * Analyzer component to display high number of columns
...
@Component({
    name: 'bkHighColumnNumbersAnalyzer',
    templateUrl: 'src/modules/analyze/rules/high-column-numbers.html'
})
export class HighColumnNumbersAnalyzerComponent extends BaseComponent {
    ...
    private getHeader(): string {
        ...
        return `${this.strings.analyze.highColumnNumbersAnalyzer.title} \(1\)`;
    }
}
